...
import fr.ign.simplu3d.iauidf.Exec_EPFIF;
import fr.ign.simplu3d.iauidf.msc.TestDatumFactory;
...
public class IAUIDFTask {
	...
	public static boolean run(File folder, File folderOut, File parameterFile, long seed) throws Exception {
		...
		ShapefileWriter.write(featC, fileName); // , CRS.decode("EPSG:2154") => supprimé à cause de la compatibilité
												// OSIG/Geotools
