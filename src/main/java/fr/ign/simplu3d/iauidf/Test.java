...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		while ((line = in.readLine()) != null) {
			...
			int art_101 = Integer.parseInt(newmap.get("ART_10_2").toString()); // ATTENTION
																				// A
																				// CHANGER
			...
			Regulation r2 = new Regulation(code_imu, libelle_zone, insee, date_approbation, libelle_de_base,
					libelle_de_dul, fonctions_2, top_zac, zonage_coherent, correction_zonage, typ_bande, bande, art_5_2,
					art_6_2, art_71_2, art_72_2, art_73_2, art_74_2, art_8_2, art_9_2, art_10_top_2, art_101_2,
					art_102_2, art_12_2, art_13_2, art_14_2);
